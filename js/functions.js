...
export let shipsToPlace = [
  ...
  export const shipMessages = {
    Mothership: {
      ...
      error: () =>
        `Deployment failed - Adjust position to stabilize orbit`
    ...
    Dreadnought: {
      deploy: (shipName) =>
        ...
        `[SPACE to rotate]`, 
      error: () =>
        `Collision alert - Select alternate coordinates`
    },
    ...
    Interceptor: {
      deploy: (shipName) =>
        ...
        `[SPACE to rotate]`,
      error: () =>
        `Deployment failure - Plasma storm interference`
    },
    ...
    Scout: {
      deploy: (shipName) =>
        ...
        `[SPACE to rotate]`,
      error: () =>
        `Scout systems compromised - Reset sensor array`
    }
  };
